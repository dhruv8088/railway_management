  ...
  return (
    <div className='flex flex-col m-[5px] gap-[10px] justify-center items-center' >
        ...
        <div className='flex flex-[1] items-start justify-between m-[20px]'>
            ...
            <Link to="/admin/feeddata" className='flex flex-[0.8] bg-[#6A1B9A] text-white text-[16px] rounded-[10px] h-[40px] p-[2px] justify-around items-center'><img src={head} height='20px' width='20px' alt='head'/>Add New Train</Link>
        </div>
        ...
        {trains && trains.map((train)=>{return(
            ...
            <Link to="/" className='flex p-[5px] justify-center items-center bg-[#FAFAFA]'><img src={arrow} height="20px" width="20px" alt='arrow'/></Link>
        </div>
        )})}
        </div>
        </div>
