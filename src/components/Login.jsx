...
import logo from '../assets/RailwayManagement_logo.png'
...
function Login() {
  ...
  return (
      ...
      {admin?(<Navigate replace to='/admin/trainlist'></Navigate>):(<div className="flex flex-[8] flex-col gap-[20px] justify-center items-center">
